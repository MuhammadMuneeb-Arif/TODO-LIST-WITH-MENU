...
while (conditions) {
    ...
    if (menu.card === "starter") {
        ...
        if (mainCourse.MAINCOURSE === "chicken Karahi" ||
        ...
        let fastFood = await inquirer.prompt([
            {
                ...
                type: "list",
                message: "What would you like to order in starter?",
                choices: ["burger", "pizza", "sandwiches", "chicken nuggets", "Shawarma"],
            },
        ]);
        if (fastFood.FASTFOOD === "burger") {
            ...
            todos.push(`${pizzaMenu.pizza} flavour of pizza  with ${pizzaMenu.sizePizza} size`);
        }
        ...
        if (dessertMenu.DESSERT === "Gulab jamun") {
        ...
        else if (dessertMenu.DESSERT === "kheer" ||
            ...
            let icecreamMenu = await inquirer.prompt([
                ...
                },
                {
                    ...
                    choices: ["2 scoops", "4 scoops", "6 scoops", "8 scoops", "12 scoops"],
                },
            ]);
            todos.push(` ${icecreamMenu.icecream} of ${icecreamMenu.icecreamFlavour} ${dessertMenu.DESSERT}`);
        }
    }
        ...
        if (drinkMenu.DRINK) {
            ...
            todos.push(`${drinkMenu.DRINK} ${drinkVolume.bottle} ${botMenu.botVolume}`);
        }
    }
    ;
    console.log(todos);
